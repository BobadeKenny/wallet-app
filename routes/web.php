...
Route::post('/withdraw', [App\Http\Controllers\BalanceController::class, "withdraw"]);
Route::post('/deposit', [App\Http\Controllers\BalanceController::class, "deposit"]);
Route::post('/transfer', [App\Http\Controllers\BalanceController::class, "transfer"]);